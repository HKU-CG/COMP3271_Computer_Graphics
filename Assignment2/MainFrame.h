...
public:
    ...
    // Shading modes
    enum { SHADING_PHONG = 0, SHADING_GLASS = 1 };
    int shading_mode_ = SHADING_PHONG;

    // Render/front-face state
    bool front_face_cw_ = false; // toggle CW/CCW front-face for glass
    int ff_key_state_ = GLFW_RELEASE;
